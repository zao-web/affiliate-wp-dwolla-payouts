...
if ( ! defined( 'AFFILIATE_WP_DWOLLA_PAYOUTS_DIR' ) ) {
	define( 'AFFILIATE_WP_DWOLLA_PAYOUTS_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'AFFILIATE_WP_DWOLLA_PAYOUTS_PATH' ) ) {
	define( 'AFFILIATE_WP_DWOLLA_PAYOUTS_PATH', 'path' );
}
